...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@llamaluvr/test-asset-bundling";
  public static final boolean IS_DETACHED = true;
  public static final String SHELL_APP_SCHEME = "exp7fd4a6c6214d462899237c695ea7e853";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@llamaluvr/test-asset-bundling/index.exp", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40llamaluvr%2Ftest-asset-bundling%2F1.0.0%2Ff490564017f88fdf3d4ebeb1c8af3020-29.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
