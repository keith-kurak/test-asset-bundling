...
public class AppConstants {
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@nudge/test-asset-bundling/index.exp", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40nudge%2Ftest-asset-bundling%2F1.0.0%2Fb9987cd732891ad9d021567e943b3046-29.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
